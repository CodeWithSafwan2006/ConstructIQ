...
- [`docs/SOFTWARE_ENGINEERING_DOCUMENTATION.md`](./docs/SOFTWARE_ENGINEERING_DOCUMENTATION.md) — Comprehensive Software Engineering & Architecture Documentation (Authored by sahilgohill).
- [`docs/DEVELOPMENT_DOCUMENTATION.md`](./docs/DEVELOPMENT_DOCUMENTATION.md) — Technical architecture & design specifications.
- [`docs/SALES_PITCH.md`](./docs/SALES_PITCH.md) — Commercial business case, SaaS pricing & market analysis.
- [`docs/DEMO_SCRIPT.md`](./docs/DEMO_SCRIPT.md) — Step-by-step presentation script & Q&A defense.
- [`docs/MARKETING_IDEAS.md`](./docs/MARKETING_IDEAS.md) — Social media posts, ad taglines & video storyboards.
