...
import { Building2, Search, Plus, MapPin, DollarSign, Layers, ArrowRight, Calendar, User, CheckCircle2, Trash2, Edit2 } from 'lucide-react';
...
export default function ProjectsView({ projects, tasks, materials, expenses, issues }) {
  const { addProject, deleteProject, setSelectedProjectId, activeRole } = useApp();
